...
for num in tqdm(range(1, num_images+1)):
    json_name = '/home/ubuntu/dl/final/match_rcnn-master/train/annos/' + str(num).zfill(6)+'.json'
    image_name = '/home/ubuntu/dl/final/match_rcnn-master/train/image/' + str(num).zfill(6)+'.jpg'
